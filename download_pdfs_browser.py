#!/usr/bin/env python3
"""
Download and parse PDFs from collected links using browser automation
(bypasses Akamai bot protection)
"""
import sys
import json
import time
...
def download_and_parse_pdfs_browser(
    links_file: Path,
    output_dir: Path,
    max_cases: int = None,
    force: bool = False,
...
if __name__ == "__main__":
    ...
    cases = download_and_parse_pdfs_browser(
