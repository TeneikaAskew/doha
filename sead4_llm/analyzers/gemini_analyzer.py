"""
Google Gemini-based SEAD-4 Analyzer

Uses Google Gemini API with structured prompting for security clearance analysis.
"""
import os
import json
...
def analyze_document(
    ...
    """
    Convenience function for single document analysis using Gemini
    ...
    Returns:
        SEAD4AnalysisResult
    """
    analyzer = GeminiSEAD4Analyzer(api_key=api_key)
...
if __name__ == "__main__":
    ...
    print("Testing SEAD-4 Analyzer (Gemini)...")
    print("=" * 60)
